...
public class NodeLinkTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        link23 = new NodeLink(node2, node3, aWeigth);
        link31 = new NodeLink(node3, node1, aWeigth);
    }
    ...
    {
        sameLink12.setWeigth(90);
        assertNotEquals(link12, sameLink12);
        //what if we again chage unibo to aWeigth= 78
        sameLink12.setWeigth(78);
        assertThat(sameLink12, equalTo(link12));
    }
    ...
    {
        NodeLink newLink = new NodeLink(node2, node1, aWeigth);
    ...
    {
        NodeLink newLink = new NodeLink(newNode1, newNode2, aWeigth);
        assertThat(newLink, equalTo(link12));
        assertThat(link12, equalTo(newLink));
        //now lets exchange nodes order
        NodeLink newLink1 = new NodeLink(newNode2, newNode1, aWeigth);
    ...
    {
        NodeLink newLink = new NodeLink(node1, aNode, aWeigth);
